...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="cce358bf-f6ea-429c-8369-adaf5defce20" noBmpOnMenu="true"
                type="checkButton"
                check="*Docker('70c68120-17f3-42ee-b6fb-60cac78e2331')"
                dynamicCategory="2cc24a3e-fe24-4708-9a74-9c75406eebcd"
                userCaption="Kerr Automate Labels"
                enable="true"/>

      <!-- Define the web control which will be placed on our docker -->
      <itemData guid="ac843211-7a51-4aea-bf45-b45a6b495faa"
                type="wpfhost"
                hostedType="Addons\DockerTemplateCS1test\DockerTemplateCS1test.dll,DockerTemplateCS1test.DockerUI"
                enable="true"/>
  ...
  <xsl:template match="uiConfig/dockers">
    <xsl:copy>
      ...
      <dockerData guid="70c68120-17f3-42ee-b6fb-60cac78e2331"
                  userCaption="Kerr Automate Labels"
                  wantReturn="true"
                  focusStyle="noThrow">
        <container>
          <!-- add the webpage control to the docker -->
          <item dock="fill" margin="0,0,0,0" guidRef="ac843211-7a51-4aea-bf45-b45a6b495faa"/>
        </container>
      </dockerData>
    </xsl:copy>
  </xsl:template>
